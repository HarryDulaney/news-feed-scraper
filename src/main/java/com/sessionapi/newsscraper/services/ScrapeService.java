...
public class ScrapeService {
    ...
    private List<String> findArticleUrls(CrawlSource crawlSource, WebDriver driver) {
    ...
    public Article scrape(String href, CrawlSource source) throws Exception {
        Article article = new Article();
            ...
            article.setImageSource(articleElement.findElement(By.xpath(source.getImageXPath())).getAttribute("src"));
